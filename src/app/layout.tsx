...
export default function RootLayout({
  ...
  return (
    // Προσθέτουμε τη μεταβλητή στο html tag

    <html lang="el" className={`${ranchersFont.variable}`}>
      <AuthProvider>
        <Navbar></Navbar>
        {/* Προσθέτουμε το class 'font-ranchers' στο body για να εφαρμοστεί σε ΟΛΟ το site */}
        <body className="bg-black text-black font-ranchers">{children}</body>
        <Footer
          brandName="Flavr"
          ...
          copyright={{ text: "© 2026 Flavr. All rights reserved." }}
        />
      </AuthProvider>
    </html>
  );
