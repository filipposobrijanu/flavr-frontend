...
import { useLocale } from "@/context/LocaleContext"; // 👈 Το δικό σου custom hook!

interface FavoritesClientProps {
  initialFavorites: any[]; // Μπορείς να βάλεις το ακριβές Prisma τύπο αν θες
}
    ...
    <div className="min-h-[calc(80vh-4rem)] p-6 md:p-12 text-black">
      <div className="max-w-6xl mx-auto">
        ...
        {initialFavorites.length === 0 ? (
          <div className="text-center py-16 px-4 border-4 border-dashed border-black rounded-3xl bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] max-w-xl mx-auto transform -rotate-1">
